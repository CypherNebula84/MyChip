...
set_input_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {A}]
set_input_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {B}]
set_output_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {OUTPUT}]
###############################################################################
# Environment
###############################################################################
set_load -pin_load 0.0334 [get_ports {OUTPUT}]
